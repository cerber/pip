...
class DiagramFactory:
    ...
    class Diagram(object):
        ...
        def __init__(self, width, height):
            self.width = width
            self.height = height
            self.diagram = DiagramFactory._create_rectangle(self,
                                self.width,
        ...
        def save(self, filenameOrFile):
            ...
            try:
                if file is None:
                    file = codecs.open(filenameOrFile, mode='w', encoding='utf-8')
...
font-family="sans-serif" font-size="{fontsize}">{text}</text>"""
    ...
    class Diagram:
        ...
        def __init__(self, width, height):
            ...
            outline = SvgDiagramFactory.SvgRectangle(0, 0, width, height,
                                                     "lightgreen", "black")
